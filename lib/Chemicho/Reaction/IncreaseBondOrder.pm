package Chemicho::Reaction::IncreaseBondOrder;
...
Chemicho::IncreaseBondOrder - Increase Bond Order
...
Perhaps a little code snippet.
    ...
    use Chemicho::IncreaseBondOrder;
    my $cvt = Chemicho::IncreaseBondOrder->new();
