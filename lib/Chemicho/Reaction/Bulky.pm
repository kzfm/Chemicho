package Chemicho::Reaction::Bulky;
...
sub react {
    ...
    my $c3 = $react->new_atom(symbol => "C");
    $c1->implicit_hydrogens(3);
    $c2->implicit_hydrogens(3);
    $c3->implicit_hydrogens(3);
    $nfg[1]->implicit_hydrogens(0);
    $react->new_bond(atoms => [$c1, $nfg[1]], order => '1');
    $react->new_bond(atoms => [$c2, $nfg[1]], order => '1');
    $react->new_bond(atoms => [$c3, $nfg[1]], order => '1');
