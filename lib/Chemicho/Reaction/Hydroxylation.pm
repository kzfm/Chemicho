package Chemicho::Reaction::Hydroxylation;
...
Perhaps a little code snippet.
    ...
    my $cvt = Chemicho::Hydroxylation->new();
...
sub react {
    ...
    my $o = $react->new_atom(symbol => "O");
    $react->new_bond(atoms => [$o, $nfg[0]], order => '1');
    $o->implicit_hydrogens(1);
